	...
	<div class="md:grid md:grid-cols-3 md:space-y-0 space-y-5">
		...
		<div>
			<div class="space-x-5 pt-3">
				...
				>
				<a class="" href="https://www.facebook.com/Hapivibe1/"><i class="fab fa-twitter fa-xl" /></a
				>
...
<footer class="border-t border-t-primary">
	<div class="container md:pb-8 px-5 py-8 mx-auto flex items-center md:flex-row flex-col">
		<a
			class="flex title-font font-medium font-bold items-center md:justify-start justify-center text-gray-900"
			href="/home"
		>
			<span>HOTEL</span><span class="underline decoration-primary text-primary">MANIA</span>
		</a>
		<p
			class="text-sm text-gray-500 md:ml-4 md:pl-4 md:border-l-2 md:border-gray-200 md:py-2 md:mt-0 mt-4"
		>
			© {year} <span class=""> HOTELMANIA</span>
		</p>
		<span
			class="inline-flex text-gray-500 md:ml-auto md:mt-0 mt-4 justify-center md:justify-start space-x-7"
		>
			<a class="" href="/home/terms">Terms of Use</a>
			<a class="" href="/home/privacy">Privacy Policy</a>
		</span>
		<span
			class="inline-flex text-gray-500 md:ml-auto md:mt-0 mt-4 justify-center md:justify-start space-x-5"
		>
			<a class="" href="/"><i class="fab fa-facebook fa-xl" /></a>
			<a class="" href="/"><i class="fab fa-twitter fa-xl" /></a>
			<a class="" href="/"><i class="fab fa-instagram fa-xl" /></a>
			<a class="" href="/"><i class="fab fa-linkedin fa-xl" /></a>
		</span>
	</div>
</footer>
